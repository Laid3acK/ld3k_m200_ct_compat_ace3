...
class CfgAmmo
{
    ...
    class ld3k_B_408_450gr_AP_Ball: ld3k_B_408_419gr_Ball // SBR .408 450gr Armor Piercing https://www.sbrammunition.com/assets/images/M408-450.pdf
    {
        ...
        hit=20; // 9520 Joules
        caliber=4.4; // SD 0.386 lb/in2, tungsten carbide core
        typicalSpeed=808;
    ...
    class ld3k_B_408_375gr_API_Ball: ld3k_B_408_419gr_Ball // Extreme Performance .408 375gr Armor Piercing Incendiary https://www.jbmballistics.com/
    {
        ...
        caliber=3.7; // SD 0.322 lb/in2, tungsten carbide core, titanium tip, no incendiary chemicals
        typicalSpeed=945;
    ...
    class ld3k_B_375_391gr_AP_Ball: ld3k_B_375_350gr_Ball // SBR .375 391gr Armor Piercing https://www.sbrammunition.com/assets/images/M375-391.pdf
    {
        ...
        hit=17; // 8089 Joules
        caliber=4.5; // SD 0.398 lb/in2, tungsten carbide core
        typicalSpeed=799;
...
class CfgMagazines
{
    ...
    class ld3k_7Rnd_408_419gr_Mag: CA_Magazine
    {
        ...
        mass=14; // 1.5 lbs, 680g https://cheytac.com/product/m200-m300-magazines-2/, .408 419gr cartridge weight 60g https://cheytac.com/wp-content/uploads/2024/12/CHEYTAC-USA-CATALOG-2024.pdf#page=16, 680+ 60x7= 1100g, 2.43 lbs
    };
    ...
    class ld3k_7Rnd_408_305gr_Mag: ld3k_7Rnd_408_419gr_Mag
    {
        ...
        mass=13.3; // 1.5 lbs, 680g https://cheytac.com/product/m200-m300-magazines-2/, .408 305gr cartridge weight 52.6g, 680+ 52.6x7= 1048g, 2.31 lbs
    };
    ...
    class ld3k_7Rnd_408_450gr_AP_Mag: ld3k_7Rnd_408_419gr_Mag
    {
        ...
        mass=14.2; // 1.5 lbs, 680g https://cheytac.com/product/m200-m300-magazines-2/, .408 450gr cartridge weight 62g, 680+ 62x7= 1114g, 2.46 lbs
        displaynameshort="AP";
    };
    class ld3k_7Rnd_408_375gr_API_Mag: ld3k_7Rnd_408_419gr_Mag
    {
        ...
        mass=13.7; // 1.5 lbs, 680g https://cheytac.com/product/m200-m300-magazines-2/, .408 375gr cartridge weight 57.15g, 680+ 57.15x7= 1080g, 2.38 lbs
    ...
    class ld3k_7Rnd_375_350gr_Mag: ld3k_7Rnd_408_419gr_Mag
    {
        ...
        mass=13.7; // 1.5 lbs, 680g https://cheytac.com/product/m200-m300-magazines-2/, .375 350gr cartridge weight 57g https://cheytac.com/wp-content/uploads/2024/12/CHEYTAC-USA-CATALOG-2024.pdf#page=17, 680+ 57x7= 1079g, 2.38 lbs
    };
    ...
    class ld3k_7Rnd_375_391gr_AP_Mag: ld3k_7Rnd_375_350gr_Mag
    {
        ...
        mass=14; // 1.5 lbs, 680g https://cheytac.com/product/m200-m300-magazines-2/, .375 391gr cartridge weight 59.7g, 680+ 59.7x7= 1098g, 2.42 lbs
        displaynameshort="AP";
    };
};
class CfgMagazineWells
{
    ...
    class M200_408
    {
        ld3k_Magazines[]= // Weapon initSpeed -1 with M200 CheyTac ACE_barrelLength 736.6mm (29"), 869, 1067, 808, 945m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to M200 CheyTac 7Rnd_408 magazines initSpeed
        {
    ...
    class M200_375
    {
        ld3k_Magazines[]= // Weapon initSpeed -1 with M200 CheyTac ACE_barrelLength 736.6mm (29"), 905, 799m/s ICAO conditions (15°C, 1013.25 hPa, 0%) according to M200 CheyTac 7Rnd_375 magazines initSpeed
        {
...
class CfgWeapons
{
    ...
    class ld3k_M200_CT_375: ld3k_M200_CT_408
    {
        ...
        maxZeroing=3300; // distance .375 CheyTac 350gr Mach 0.8 (272m/s) ICAO, LRR_base_F 2400
        // initSpeed=-1; // 905, 799m/s according to ACE_muzzleVelocities ICAO conditions (15°C, 1013.25hPa, 0%), LRR_base_F 910
    ...
    class ld3k_muzzle_snds_408: ItemCore // muzzle_snds_93mmg
    {
        ...
        tBody=100;
        scope=2;
        displayName="Sound Suppressor (.375/.408, Black)";
        picture="\a3\Weapons_F_Mark\Data\UI\icon_muzzle_snds_93mmg_ca.paa";
        model="\A3\Weapons_F\Acc\acca_snds_93mmg_F.p3d";
        DLC="Mark";
        class ItemInfo: InventoryMuzzleItem_Base_F
        {
            mass=12.4; // based on CheyTac M3 Suppressor 2025 (integrated muzzle brake) https://cheytac.com/wp-content/uploads/2025/01/Cheytac-M3-Sup-Spec-Sheet-pdf.jpg, muzzle_snds_93mmg 12
            class MagazineCoef
            {
    ...
    class ld3k_muzzle_snds_408_tan: ld3k_muzzle_snds_408
    {
        ...
        displayName="Sound Suppressor (.375/.408, Tan)";
        ...
        class ItemInfo: ItemInfo
        {
            ...
            class OpticsModes: OpticsModes
            {
                class Snip: Snip
                {
                    ...
                    discreteDistance[]={100,200,300,400,500,600,700,800,900,1000,1100,1200,1300,1400,1500,1600,1700,1800,1900,2000,2100,2200,2300,2400}; // max distance at max elevation 29 mRad .375 CheyTac 350gr (zeroing 100m, ICAO conditions)
